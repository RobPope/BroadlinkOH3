...
public class BroadlinkHandlerFactory extends BaseThingHandlerFactory {
    ...
    protected @Nullable ThingHandler createHandler(Thing thing) {
        ...
        if (thingTypeUID.equals(BroadlinkBindingConstants.THING_TYPE_SP3S))
            return new BroadlinkSocketModel3Handler(thing);
        if (thingTypeUID.equals(BroadlinkBindingConstants.THING_TYPE_SP4B))
            return new BroadlinkSocketModelBG1Handler(thing);
        if (thingTypeUID.equals(BroadlinkBindingConstants.THING_TYPE_BG1))
            return new BroadlinkSocketModelBG1Handler(thing);
        if (thingTypeUID.equals(BroadlinkBindingConstants.THING_TYPE_U01))
            return new BroadlinkSocketModelU01Handler(thing);
